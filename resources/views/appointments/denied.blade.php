            ...
            <div class="col-md-12">
                <div>
                    ...
                    <div>
                        ...
                        D E N I E D<b style="color: #bb2124"> A P P O I N T M E N T S</b>
                        </h2>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header bg-danger">
          <h5 class="modal-title text-white" id="exampleModalLabel">Delete Denied Appointment Confirmation</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <div class="modal-body text-center">
            <form action="{{ route('myappointments.delete', Auth::user()->id) }}" method="POST">
                @csrf
                @method('DELETE') 
