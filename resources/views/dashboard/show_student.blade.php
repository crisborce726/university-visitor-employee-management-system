@section('title', 'Active Students | UB-SEVMS')
@extends('layouts.app')
...
<div class="">
        ...
        <table>
            <form action="{{ route('indexFilter.listStudent') }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
            <tr>
                <input name="page" id="page" class="form-control" value="activeStudents" hidden>
            </tr>
            <tr class="ml-2">
                <td>
                ...
                <td>
                    <a class="btn btn-primary" href="/active/students"><i class="fas fa-redo"></i> <b>R E F R E S H</b></a>
                </td>
            </tr>
        </table>
        ...
        <div class="containers-fluid mt-2">
            <table class="table table-hover table-sm mt-2">
                ...
                <tbody id="dynamic-row" >
                    @foreach ($activeStudent as $key => $value)
                        <tr>
                    ...
                    @endforeach
                    <td colspan="7">
                        {{ $activeStudent->appends($data)->links() }}
                    </td>
                    
                </tbody>
            </table>
            @if(count($activeStudent) == 0)
